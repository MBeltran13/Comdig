...
class SerialPlot(QWidget):
    def __init__(self, parent=None):
        ...
        self.graphWidget.setLabel('left', 'Acelerómetro', units='m/s^2')
        ...
        self.graphWidget2.setLabel('left', 'Giroscopio', units='grados/s')
        ...
        num_points = 10000  # Número de puntos a mostrar en la gráfica
    ...
    def save_data_csv(self):
        ...
        with open('save_data.csv', 'w', newline='') as archivo_csv:
            ...
            writer.writerow(['Tiempo', 'AcX', 'AcY', 'AcZ', 'GyX', 'GyY', 'GyZ', 'Altura'])
